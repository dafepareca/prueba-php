...
class BusinessUnitsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'campaign_count' => ['type' => 'integer', 'length' => 4, 'unsigned' => false, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'campaign_count' => 1,
            'created' => '2017-04-10 22:36:04',
            'modified' => '2017-04-10 22:36:04'
        ],
    ];
}
