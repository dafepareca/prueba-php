...
class DashboardsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'access_public' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'access_public' => 'Lorem ipsum dolor sit amet',
            'created' => '2017-04-18 18:06:38',
            'modified' => '2017-04-18 18:06:38'
        ],
    ];
}
