...
/**
 * AdjustedObligationsDetailFixture
 *
 */
class AdjustedObligationsDetailFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'adjusted_obligations_detail';
    ...
    public $fields = [
        ...
        'monthly_rate' => ['type' => 'decimal', 'length' => 4, 'precision' => 2, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        ...
        'adjusted_obligations_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
