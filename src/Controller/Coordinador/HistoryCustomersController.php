        ...
        try {
            ...
            if($HistoryCustomersGetCount > 0) {
                ...
                if ($HistoryCustomersUpdate == null || $HistoryCustomersUpdate == 0 || $HistoryCustomersUpdate < 0) {
                    throw new Exception("Se genero un error al momento de realizar actualización de la información en la tabla HistoryCustomers en la funcion entregaDocumentos del controlador HistoryCustomers (COORDINADOR)");
                }
            }
            ...
            $mensaje = "Se presento un error en la funcion entrega de documentos perfil coodinador";
            $parametro = [
    ...
    public function desisteNegociacion()
    {
        ...
        try{
            ...
            if($HistoryCustomersGetCount > 0) {
                ...
                if ($HistoryCustomersUpdate == null || $HistoryCustomersUpdate == 0 || $HistoryCustomersUpdate < 0) {
                    throw new Exception("Se genero un error al momento de realizar actualización de la información en la tabla HistoryCustomers en la funcion desisteNegociacion del controlador HistoryCustomers (COORDINADOR)");
                }
            }
            ...
            $mensaje = "Se presento un error en la funcion desiste de negociación perfil coordinador";
            $parametro = [
                'history_id' => $this->request->getQuery('id')
            ];
            $logTran = LogTransaccionController::EscribirLog($mensaje,$parametro,$th);
