<?php
/** @var  $charge \App\Model\Entity\Charge */
/** @var  $Html \Cake\View\Helper\HtmlHelper */
?>
<section class="content-header">
    <h1 class="pull-left"><?= $this->Html->icon('list') . ' ' . __('Charges') ?> |
        <small><?= __('Add') ?></small>
    </h1>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title"><?= __('Charge Information') ?></h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                ...
                <div class="box-body">
                    <div class="col col-md-8">
                        <?= $this->Form->input('file',['type' => 'file','help'=>__('These files extension are allowed: {0} ','.csv, .zip')]) ?>
                    </div>
                    <div class="col col-md-8">
                        <?= $this->Form->input('number_records') ?>
                    </div>
                </div>
                <!-- /.box-body -->
