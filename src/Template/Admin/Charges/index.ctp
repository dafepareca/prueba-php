                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <ul class="dropdown-menu flat">
                                           <!-- <li>
                                                <?= $this->Html->link($this->Html->icon('edit').' '.__('Edit'), ['action' => 'edit', $charge->id],
                                                ['class' => 'load-ajax', 'update' => '#page-content-wrapper', 'escape' => false]) ?>
                                            </li>
                                            <li>
                                                <?= $this->Html->link($this->Html->icon('eye').' '.__('View'), ['action' => 'view', $charge->id],
                                            ...
                                            <li>
                                                ...
                                                ['escape' => false,
                                                    ...
                                                    'data-action' => Router::url(['action' => 'delete', $charge->id], false),]
                                                ) ?>
                                            </li>
                                        </ul>
                                    </div>
