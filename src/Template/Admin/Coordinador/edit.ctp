...
<section class="content-header">
    <h3 class="pull-left"><?= $this->Html->icon('users') . ' ' . __('Coordinador') ?> |
        <small><?= __('Edit') ?></small>
    </h3>
    <div class="btn-group pull-right">
        <?= $this->Html->link($this->Html->icon('chevron-left') . ' ' . $this->Html->tag('span', __('Back'), ['class' => 'hidden-xs hidden-sm']),
            ['controller' => 'coordinador','action' => 'index','busines_id' => $business->id], ['escape' => false, 'class' => 'load-ajax btn btn-sm btn-default', 'update' => '#page-content-wrapper', 'title' => __('Back')]) ?>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <h4 class="box-title"><?= __('Coordinador Information') ?></h4>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <?= $this->Form->create($user, [
                    ...
                    'horizontal' => true,
                    'type' => 'file',
                    'url' => ['controller' => 'coordinador', 'action' => 'edit', 'busines_id' => $user->busines_id]
                ]) ?>
                <div class="box-body">
                    <div class="col-md-6">
                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <?php if($this->request->getQuery('all_user')){
                            echo $this->Form->control('all_user',['type' =>'hidden', 'value' => '1']);
                        } ?>
