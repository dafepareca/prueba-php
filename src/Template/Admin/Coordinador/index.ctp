...
<section class="content-header">
    <h3 class="pull-left"><?= $this->Html->icon('users') . ' ' . __('Perfil').' ' ?>|
        <small><?= __('Coordinadores').' - '.$business->name ?></small></h3>
    <div class="btn-group pull-right" role="group">
        ...
        <?= $this->Html->link($this->Html->icon('plus') . ' ' . $this->Html->tag('span', __('Add'), ['class' => 'hidden-xs hidden-sm']),
            ['controller' => 'coordinador','action' => 'add','busines_id' => $business->id], ['update' => '#page-content-wrapper', 'escape' => false, 'class' => 'load-ajax btn btn-sm btn-info', 'title' => __('Add')]) ?>
                                                ...
                                                <li>
                                                    <?= $this->Html->link($this->Html->icon('folder') . ' ' . __('Archive'),
                                                        ...
                                                        ['escape' => false,
                                                            ...
                                                            'data-action' => Router::url(['controller' => $controller, 'action' => 'archive', $user->id, 'busines_id' => $business->id], false),]
                                                    );
                                                    ?>
                                                </li>
                                            <?php endif; ?>
