<?php
/** @var  $user \App\Model\Entity\Coordinador */
        ...
        <div class="box-footer no-padding">
            <ul class="nav nav-stacked">
                <li><a href="#"><?= $this->Html->icon('at') . ' ' . __('Email') ?>
                        <span class="pull-right text-info"><?= h($user->email) ?></span></a>
                </li>
                ...
                <li>
                    <a href="#"><?= $this->Html->icon('clock-o') . ' ' . __('Start Date') ?>
                        <span class="pull-right text-info"><?= $user->start_date->format('Y-m-d') ?></span></a>
                </li>

                <li>
                    <a href="#"><?= $this->Html->icon('clock-o') . ' ' . __('End Date') ?>
                        <span class="pull-right text-info"><?= $user->end_date->format('Y-m-d') ?></span></a>
                </li>
