        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <?= $this->element('search/tickets_admin') ?>
                    ...
                    <table class="table table-hover table-condensed table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th><?= $this->Paginator->sort('ticket_type_error') ?></th>
                                <th><?= $this->Paginator->sort('state') ?></th>
                                <th><?= $this->Paginator->sort('user_id') ?></th>
                                <th><?= $this->Paginator->sort('solved_by') ?></th>
                                <th><?= $this->Paginator->sort('approved_by') ?></th>
                                <th><?= $this->Paginator->sort('date_delivery') ?></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $ticket->has('solved') ? $ticket->solved->name : '' ?></td>
                                <td><?= $ticket->has('approved') ? $ticket->approved->name : '' ?></td>
                                <td><?= (!empty($ticket->date_delivery))?h($ticket->date_delivery->format('Y-m-d H:i')):'' ?></td>
