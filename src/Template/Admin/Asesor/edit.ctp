...
<section class="content-header">
    ...
    <div class="btn-group pull-right">
        <?= $this->Html->link($this->Html->icon('chevron-left') . ' ' . $this->Html->tag('span', __('Back'), ['class' => 'hidden-xs hidden-sm']),
            ['controller' => 'asesor','action' => 'index','busines_id' => $business->id], ['escape' => false, 'class' => 'load-ajax btn btn-sm btn-default', 'update' => '#page-content-wrapper', 'title' => __('Back')]) ?>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-default">
                ...
                <?= $this->Form->create($user, [
                    ...
                    'horizontal' => true,
                    'type' => 'file',
                    'url' => ['controller' => 'asesor', 'action' => 'edit', 'busines_id' => $user->busines_id]
                ]) ?>
                <div class="box-body">
                    <div class="col-md-6">
