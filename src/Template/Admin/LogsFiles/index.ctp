...
/** @var  $logsFiles \App\Model\Entity\Logs File[] */
/** @var  $Html \Cake\View\Helper\HtmlHelper*/
?>
<!-- Content Header (Page header) -->
<section class="content-header">
    <h1 class="pull-left"><?= $this->Html->icon('list') . ' ' . __('Logs Files') ?></h1>
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-hover table-condensed table-striped table-bordered">
                        ...
                        <tbody>
                            <?php foreach ($logsFiles as $logsFile): ?>
                            <tr>
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <ul class="dropdown-menu flat">
                                            <li>
                                                <?= $this->Html->link($this->Html->icon('download').' '.__('Download'), ['action' => 'download', $logsFile->id],
                                                    ['update' => '#page-content-wrapper', 'escape' => false]) ?>
                                            </li>
                                            <!--<li>
                                                <?= $this->Html->link($this->Html->icon('edit').' '.__('Edit'), ['action' => 'edit', $logsFile->id],
                                                ['target' => '_blank', 'update' => '#page-content-wrapper', 'escape' => false]) ?>
                                            </li>
                                            <li>
                                                <?= $this->Html->link($this->Html->icon('eye').' '.__('View'), ['action' => 'view', $logsFile->id],
                                            ...
                                            <li>
                                                ...
                                                ['escape' => false,
                                                    ...
                                                    'data-action' => Router::url(['action' => 'delete', $logsFile->id], false),]
                                                ) ?>
                                            </li>-->
                                        </ul>
                                    </div>
                                </td>
                                <td><?= h($logsFile->name_file) ?></td>
                                <td><?= h($logsFile->created) ?></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
