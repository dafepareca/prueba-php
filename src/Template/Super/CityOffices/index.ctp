...
/** @var  $cityOffices \App\Model\Entity\City Office[] */
/** @var  $Html \Cake\View\Helper\HtmlHelper*/
?>
<!-- Content Header (Page header) -->
<section class="content-header">
    <h1 class="pull-left"><?= $this->Html->icon('list') . ' ' . __('City Offices') ?></h1>
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-hover table-condensed table-striped table-bordered">
                        ...
                        <tbody>
                            <?php foreach ($cityOffices as $cityOffice): ?>
                            <tr>
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <ul class="dropdown-menu flat">
                                            <li>
                                                <?= $this->Html->link($this->Html->icon('edit').' '.__('Edit'), ['action' => 'edit', $cityOffice->id],
                                                ['class' => 'load-ajax', 'update' => '#page-content-wrapper', 'escape' => false]) ?>
                                            </li>
                                            <li>
                                                <?= $this->Html->link($this->Html->icon('eye').' '.__('View'), ['action' => 'view', $cityOffice->id],
                                            ...
                                            <li>
                                                ...
                                                ['escape' => false,
                                                    'class' => 'btn-confirm',
                                                    'data-id' => $cityOffice->id,
                                                    'data-toggle' => 'modal',
                                                    'data-target' => '#ConfirmDelete',
                                                    'data-action' => Router::url(['action' => 'delete', $cityOffice->id], false),]
                                                ) ?>
                                            </li>
                                            <li class="divider"></li>
                                            <li>
                                                <?=$this->Html->link($this->Html->icon('home') . ' ' . __('branch offices'),
                                                    ['controller' => 'offices', 'action' => 'index', 'city_office_id' => $cityOffice->id],
                                                    ['class' => 'load-ajax', 'update' => '#page-content-wrapper', 'escape' => false]);
                                                ?>
                                            </li>
                                        </ul>
