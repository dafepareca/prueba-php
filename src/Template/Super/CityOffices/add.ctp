<?php
/** @var  $cityOffice \App\Model\Entity\City Office */
/** @var  $Html \Cake\View\Helper\HtmlHelper */
?>
<section class="content-header">
    <h1 class="pull-left"><?= $this->Html->icon('list') . ' ' . __('City Offices') ?> |
        <small><?= __('Add') ?></small>
    </h1>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title"><?= __('City Office Information') ?></h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <?= $this->Form->create($cityOffice, [
                    'class' => 'form-ajax',
                ...
                <div class="box-body">
                    <div class="col-md-8">
                        ...
                        <?= $this->Form->input('parking_no_capture') ?>
                        <?= $this->Form->input('parking_agreement') ?>
                        <?= $this->Form->input('parking_no_agreement') ?>
                    </div>
                </div>
                <!-- /.box-body -->
