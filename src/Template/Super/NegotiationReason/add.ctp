...
<section class="content-header">
    <h1 class="pull-left"><?= $this->Html->icon('list') . ' ' . __('Negotiation Reason') ?> |
        <small><?= __('Add') ?></small>
    </h1>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title"><?= __('Negotiation Reason Information') ?></h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <?= $this->Form->create($negotiationReason, [
                    'class' => 'form-ajax',
                    'update' => '#page-content-wrapper',
                    'horizontal' => true
                ]) ?>
                <div class="box-body">
                    <?= $this->Form->input('id_reason') ?>
                    <?= $this->Form->input('Descption_reason') ?>
                    <?= $this->Form->input('code_reason') ?>
                    <?= $this->Form->input('codigo_terceros') ?>
                </div>
                <!-- /.box-body -->
