<?php
/** @var  $settingCategory \App\Model\Entity\Setting Category */
/** @var  $Html \Cake\View\Helper\HtmlHelper */
?>
<section class="content-header">
    <h1 class="pull-left"><?= $this->Html->icon('cogs') . ' ' . __('Setting Categories') ?> |
        <small><?= __('Add') ?></small>
    </h1>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title"><?= __('Setting Category Information') ?></h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <?= $this->Form->create($settingCategory, [
                    'class' => 'form-ajax',
