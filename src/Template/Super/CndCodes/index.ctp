...
/** @var  $cndCodes \App\Model\Entity\Cnd Code[] */
/** @var  $Html \Cake\View\Helper\HtmlHelper*/
?>
<!-- Content Header (Page header) -->
<section class="content-header">
    <h1 class="pull-left"><?= $this->Html->icon('list') . ' ' . __('Cnd Codes') ?></h1>
                    ...
                    <table class="table table-hover table-condensed table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th><?= $this->Paginator->sort('not_negotiate') ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php foreach ($cndCodes as $cndCode): ?>
                            <tr>
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <ul class="dropdown-menu flat">
                                            <li>
                                                <?= $this->Html->link($this->Html->icon('edit').' '.__('Edit'), ['action' => 'edit', $cndCode->id],
                                                ['class' => 'load-ajax', 'update' => '#page-content-wrapper', 'escape' => false]) ?>
                                            </li>
                                            <li>
                                                <?= $this->Html->link($this->Html->icon('eye').' '.__('View'), ['action' => 'view', $cndCode->id],
                                            ...
                                            <!--<li>
                                                ...
                                                ['escape' => false,
                                                    ...
                                                    'data-action' => Router::url(['action' => 'delete', $cndCode->id], false),]
                                                ) ?>
                                            </li>-->
                                        </ul>
                                    </div>
                                </td>
                                <td><?= $this->Number->format($cndCode->code) ?></td>
                                <td><?= (!$cndCode->not_negotiate)?'Si':'No' ?></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
