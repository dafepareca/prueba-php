...
<section class="content-header">
    <h1 class="pull-left"><?= $this->Html->icon('users') . ' ' . __('Internal Customer') ?> |
        <small><?= __('Add') ?></small>
    </h1>
                ...
                <div class="box-body">
                    ...
                    <div class="col-sm-6">
                        <div class="col-md-offset-4 col-sm-offset-3 col-md-8">
                            <?= $this->Nested->_thumb('photo', null, 'large', ['id' => 'avatar', 'class' => 'img-thumbnail', 'style' => 'margin-bottom:6px']);?>
                        </div>
                    ...
                    <div class="col-sm-6">
                        <div style="max-height: 250px; overflow: auto; border: 1px solid #CCC;">
                            <table id="row-table" class="table table-hover table-condensed table-striped">
                                ...
                                <tbody>
                                <?php if (!empty($this->request->data['campaigns_internal_customers'])) :
                                    $key = 0;
