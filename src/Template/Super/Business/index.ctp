                    ...
                    <table class="table table-hover table-condensed table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th><?= $this->Paginator->sort('name_contact') ?></th>
                                <th><?= $this->Paginator->sort('phone_contact') ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <ul class="dropdown-menu flat">
                                            <li>
                                                <?= $this->Html->link($this->Html->icon('edit').' '.__('Edit'), ['action' => 'edit', $busines->id],
                                            ...
                                            <li>
                                                ...
                                                ['escape' => false,
                                                    ...
                                                    'data-action' => Router::url(['action' => 'delete', $busines->id], false),]
                                                ) ?>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <td><?= h($busines->nit) ?></td>
                                <td><?= h($busines->name_contact) ?></td>
                                <td><?= h($busines->phone_contact) ?></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
