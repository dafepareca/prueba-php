...
<section class="content-header">
    ...
    <div class="btn-group pull-right" role="group">
        ...
        <ul class="dropdown-menu dropdown-menu-left " role="menu">
            ...
            <li>
                <?= $this->Html->link($this->Html->icon('user') . ' ' . __('Asesor'),
                    ['controller' => 'Asesor', 'action' => 'add'], ['update' => '#page-content-wrapper', 'escape' => false, 'class' => 'load-ajax']) ?>
            </li>
            <li>
                <?= $this->Html->link($this->Html->icon('user') . ' ' . __('Unit Manager'),
                    ['controller' => 'UnitManagers', 'action' => 'add'], ['update' => '#page-content-wrapper', 'escape' => false, 'class' => 'load-ajax']) ?>
            </li>
            <li>
                <?= $this->Html->link($this->Html->icon('user') . ' ' . __('Bi User'),
                    ['controller' => 'BiUsers', 'action' => 'add'], ['update' => '#page-content-wrapper', 'escape' => false, 'class' => 'load-ajax']) ?>
            </li>
            <li>
                <?= $this->Html->link($this->Html->icon('user') . ' ' . __('Internal Customer'),
                    ['controller' => 'InternalCustomers', 'action' => 'add'], ['update' => '#page-content-wrapper', 'escape' => false, 'class' => 'load-ajax']) ?>
            </li>
            <li>
                <?= $this->Html->link($this->Html->icon('user') . ' ' . __('External Customer'),
                    ['controller' => 'ExternalCustomers', 'action' => 'select_customer'], ['data-toggle' => 'modal', 'data-target' => '#genericModal', 'escape' => false]) ?>
            </li>
        </ul>
                    ...
                    <table class="table table-hover table-condensed">
                        ...
                        <?php foreach ($users as $user): ?>
                            ...
                            if($user->role_id == \App\Model\Table\RolesTable::Admin) {
                                $controller = 'users';
                            }elseif($user->role_id == \App\Model\Table\RolesTable::Manager){
                                $controller = 'unitManagers';
                            }elseif($user->role_id == \App\Model\Table\RolesTable::Internal){
                                $controller = 'internalCustomers';
                            }elseif($user->role_id == \App\Model\Table\RolesTable::External){
                                $controller = 'externalCustomers';
                            }elseif($user->role_id == \App\Model\Table\RolesTable::Bi){
                                $controller = 'biUsers';
                            }
                            ?>
                            <tr class="<?= $user->user_status->label; ?>">
                                ...
                                <td><?= $this->Nested->_thumb('photo', $user->attachment, 'small', [ 'class' => 'img-responsive']);?></td>
                                <td><?= h($user->name) ?></td>
                                <td><?= h($user->email) ?></td>
                                <td><?= h($user->mobile) ?></td>
