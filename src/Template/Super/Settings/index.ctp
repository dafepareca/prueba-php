...
/** @var  $settings \App\Model\Entity\Setting[] */
/** @var  $Html \Cake\View\Helper\HtmlHelper*/
?>
<!-- Content Header (Page header) -->
<section class="content-header">
    <h1 class="pull-left"><?= $this->Html->icon('cog') . ' ' . __('Settings') ?></h1>
                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-hover table-condensed table-striped">
                        <thead>
                            <tr>
                                <th width="30"></th>
                                <th><?= $this->Paginator->sort('setting_category_id', __('Category')) ?></th>
                                <th><?= $this->Paginator->sort('name') ?></th>
                                <th><?= __('Label') ?></th>
                                <th><?= __('value') ?></th>
                                <th width="100"><?= __('Type key') ?></th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <ul class="dropdown-menu flat">
                                            <li>
                                                <?= $this->Html->link($this->Html->icon('edit').' '.__('Edit'), ['action' => 'edit', $setting->id],
                                            ...
                                            <li>
                                                ...
                                                ['escape' => false,
                                                    ...
                                                    'data-action' => Router::url(['action' => 'delete', $setting->id], false),]
                                                ) ?>
                                            </li>
                                        </ul>
                                    </div>
                                </td>
                                <td><?= h($setting->setting_category->name) ?></td>
                                <td><?= h($setting->name) ?></td>
                                <td><?= h($setting->label) ?></td>
                                <td><?= h($setting->value) ?></td>
                                <td><?= h($setting->type_key) ?></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
