...
<section class="content-header">
    <h1 class="pull-left"><?= $this->Html->icon('list') . ' ' . __('Modal Message') ?></h1>
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-hover table-condensed table-striped table-bordered">
                        ...
                        <tbody>
                            <?php foreach ($modalMessage as $modalMessage): ?>
                            <tr>
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <ul class="dropdown-menu flat">
                                            <li>
                                                <?= $this->Html->link($this->Html->icon('edit').' '.__('Edit'), ['action' => 'edit', $modalMessage->id],
                                                ['class' => 'load-ajax', 'update' => '#page-content-wrapper', 'escape' => false]) ?>
                                            </li>
                                            <li>
                                                <?= $this->Html->link($this->Html->icon('eye').' '.__('View'), ['action' => 'view', $modalMessage->id],
                                            ...
                                            <li>
                                                ...
                                                ['escape' => false,
                                                    ...
                                                    'data-action' => Router::url(['action' => 'delete', $modalMessage->id], false),]
                                                ) ?>
                                            </li>
                                        </ul>
                                    </div>
                                </td>
                                <td><?= h($modalMessage->titulo) ?></td>
                                <td><?= h($modalMessage->mensaje) ?></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
