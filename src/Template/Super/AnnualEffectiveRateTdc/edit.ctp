...
<section class="content-header">
    <h1 class="pull-left"><?= $this->Html->icon('list') . ' ' . __('Annual Effective Rate Tdc') ?> |
        <small><?= __('Edit') ?></small>
    </h1>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title"><?= __('Annual Effective Rate Tdc Information') ?></h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <?= $this->Form->create($annualEffectiveRateTdc, [
                    'class' => 'form-ajax',
                ...
                <div class="box-body">
                    <div class="col-md-8">
                        ...
                        <?= $this->Form->control('fecha',['type' => 'text','class' => 'datetimepicker']) ?>
                    </div>
                </div>
                <!-- /.box-body -->
