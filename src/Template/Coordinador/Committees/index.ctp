                    ...
                    <table class="table table-hover table-condensed table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <ul class="dropdown-menu flat">
                                            <li>
                                                <?= $this->Html->link($this->Html->icon('eye').' '.__('Gestionar'), ['action' => 'view', $committee->id],
                                ...
                                <td><?= $committee->has('asesor') ? $committee->asesor->busines->name : '' ?></td>
                                <td><?= $committee->has('history_customer') ? ($committee->history_customer->legal_process)?'Si':'No' : '' ?></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
