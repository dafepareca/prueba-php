...
<section class="content-header">
    <h3 class="pull-left"><?= $this->Html->icon('users') . ' ' . __('Lista de Perfiles') ?></h3>
    <div class="btn-group pull-right" role="group">
        ...
        <ul class="dropdown-menu dropdown-menu-left " role="menu">
            ...
            <li>
                <?= $this->Html->link($this->Html->icon('user') . ' ' . __('Consultor'),
                    ['controller' => 'consultor', 'action' => 'add'], ['update' => '#page-content-wrapper', 'escape' => false, 'class' => 'load-ajax']) ?>
            </li>
        </ul>
