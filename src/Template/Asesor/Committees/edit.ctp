...
<section class="content-header">
    <h1 class="pull-left"><?= $this->Html->icon('list') . ' ' . __('Committees') ?> |
        <small><?= __('Edit') ?></small>
    </h1>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title"><?= __('Committee Information') ?></h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                ...
                <div class="box-body">
                    <?= $this->Form->input('coordinator_id', ['options' => $users]) ?>
                    <?= $this->Form->input('history_id', ['options' => $historyCustomers]) ?>
                </div>
                <!-- /.box-body -->
