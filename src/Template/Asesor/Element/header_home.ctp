    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right link-menu">
                ...
                <?php if($current_user['view_committees']): ?>
                <li>
                ...
                <?php if(isset($current_user['solve_tickets']) && $current_user['solve_tickets']): ?>
                    <li>
                        <?= $this->Html->link($this->Html->icon('ticket') . ' ' . __('SOS').'<span class="label label-danger">'.$numTickets.'</span>',
