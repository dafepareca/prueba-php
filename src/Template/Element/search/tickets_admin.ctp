...
<div class="searchForm">
    ...
    <?= $this->Form->input('title', [
        ...
        'label' => false, 'placeholder' => __('Search by title'),
        'prepend' =>
            $this->Form->dropdownButton('',
                [
                    $this->Panel->create().
                    $this->Panel->body(
                        $this->Form->input('ticket_state_id', [ 'options' => $ticketsStatus, 'empty' => __('Select Item')])
                        .$this->Form->input('priority', [ 'options' => [1=>'Alta', 2=>'Media',3=>'Baja'], 'empty' => __('Select Item')])
                        .$this->Form->input('ticket_type_error_id', [ 'options' => $typesErrors, 'empty' => __('Select Item')])
                    ).
                    $this->Panel->footer(
