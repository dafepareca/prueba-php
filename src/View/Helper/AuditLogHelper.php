...
class AuditLogHelper extends Helper
{
	...
	public function getEvent($item)
    {
		switch (strtolower($item->event)) {
			case 'create'	: return '<span class="label label-lg label-success">create</span>';
			case 'edit'		: return '<span class="label label-lg label-warning">edit</span>';
			case 'delete'	: return '<span class="label label-lg label-danger">delete</span>';
			default 		: return '<span class="label label-lg label-default">' . $item->event . '</span>';
		}
	}
    ...
    {
		return $item->access_log->user->name;
	}
